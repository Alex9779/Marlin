...
#define STRING_CONFIG_H_AUTHOR "Alex9779+strips" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "strips BigBox Dual"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,360,1600,304}  // default steps per unit for Ultimaker
